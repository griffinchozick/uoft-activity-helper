...
#START of the program!!
    ...
    with sync_playwright() as p:
        ...
        rooms_list = {
            "East Common Room": '//*[@id="main"]/article/section[5]/div/div/ul/li[1]/a',
            "Bickerseth Room": '//*[@id="main"]/article/section[5]/div/div/ul/li[2]/a',
            "Music Room": '//*[@id="main"]/article/section[5]/div/div/ul/li[3]/a',
            "South Sitting Room": '//*[@id="main"]/article/section[5]/div/div/ul/li[4]/a'
        }
